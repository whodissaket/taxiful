...
const Drop: React.FC = () => {
  ...
  const categories = [
    {
      id: 1,
      carLink:
        "https://d1a3f4spazzrp4.cloudfront.net/car-types/haloProductImages/v1.1/UberX_Hourly.png",
      name: "Solo",
  ...
  const tripPrice: any = useCallback(
    (multiplier: number) => {
      ...
      const tripPrice = new Intl.NumberFormat("en-US", {
        ...
        travelInfo !== null
          ? (travelInfo.duration.value * SURGE_FACTOR * multiplier) / 10
          : 0
      );
      return tripPrice;
    },
  ...
  return (
    <div>
      ...
      <FormCard heading="Choose a ride.">
          ...
          <div className=" absolute  z-10 w-full bg-white left-0 right-0 bottom-[110px] sm:bottom-0  px-5 py-2 h-[80%] sm:h-[57%]">
            ...
            <div className="top py-2">
              ...
              <div className="extra-details text-base text-gray-600">
                {`${details.showSeater ? `4 Seats.` : ""}  ${
                  details.extraDetails ? `${details.extraDetails}` : ""
                }`}
              </div>
            </div>
            <hr />
            <div className="bottom pt-3 border-t-2 border-gray-500 border-solid">
              <p className="text-sm text-gray-500">
                Your fare will be the price presented before the trip or based
        ...
        {biggerScreen && (
          ...
          alt="payment-method" src="https://tb-static.uber.com/prod/wallet/icons/stored_value_3x.png"></img> */}
              ...
              <div className="details  font-medium ml-4">UPI</div>
            </div>
            <button
              onClick={() => {
          ...
          <div className="cash_request flex pb-2.5">
            <div className="icon">
              <img
                ...
                alt="payment-method"
                src="https://tb-static.uber.com/prod/wallet/icons/stored_value_3x.png"
              ></img>
            </div>
